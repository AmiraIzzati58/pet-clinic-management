...
<div class="wrapper row3">
  <main id="container" class="clear"> 
    ...
    <table style="text-align:left">
	  <tr>
	    <th scope="row" style="width:30%;text-align:center">Owner Id</th>
	    <td><c:out value="${o.ownerId}"/></td>
	  </tr>
	  <tr>
	    <th scope="row" style="width:30%;text-align:center">Owner Name</th>
	    <td><c:out value="${o.ownerName}"/></td>
	  </tr>
	  <tr>
	    <th scope="row" style="width:30%;text-align:center">Owner Phone No</th>
	    <td><c:out value="${o.ownerPhoneNo}"/></td>
	  </tr>
	  <tr>
	    <th scope="row" style="width:30%;text-align:center">Owner Address</th>
