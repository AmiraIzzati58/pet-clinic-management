...
<html>
<head>
<title>Pet Clinic | Pet Detail</title>
...
<div class="wrapper row3">
  <main id="container" class="clear"> 
    ...
    <table style="text-align:left">
	  <tr>
	    <th scope="row" style="width:30%;text-align:center">Pet Id</th>
	  ...
	  <tr>
	    <th scope="row" style="width:30%;text-align:center">Pet DOB</th>
	    <td><c:out value="${p.petDOB}"/></td>
	  </tr>
	  <tr>
	    <th scope="row" style="width:30%;text-align:center">Pet Color</th>
	    <td><c:out value="${p.petColor}"/></td>
	  </tr>
	  <tr>
	    <th scope="row" style="width:30%;text-align:center">Pet Breed</th>
	    <td><c:out value="${p.petBreed}"/></td>
	  </tr>
	  <tr>
	    <th scope="row" style="width:30%;text-align:center">Pet Sex</th>
	    <td><c:out value="${p.petSex}"/></td>
	  </tr>
	  <tr>
	    <th scope="row" style="width:30%;text-align:center">Owner's Name</th>
	    <td><c:out value="${p.owner.ownerName}"/></td>
	  </tr>
	</table>
