...
<html>
<head>
<title>Pet Clinic | Veterinar List</title>
...
<div class="wrapper row3">
  <main id="container" class="clear"> 
    <!-- container body --> 
    <!-- ########################################################################################## -->	
	 <div><input type="button" class="btn-list new" onclick="location.href='veterinar/vet-add.jsp';" value="Add New"/></div>
	<h1>Veterinar List</h1>
	<br>
   ...
   <thead>
    ...
    <tbody>
        <c:forEach items="${vets}" var="v" varStatus="vets">
        <tr>
           ...
           <td>
           <input type="button" class="btn-list view" onclick="location.href='ViewVeterinarController?vetId=<c:out value="${v.vetId}"/>'" value="View"/>
           <input type="button" class="btn-list update" onclick="location.href='UpdateVeterinarController?vetId=<c:out value="${v.vetId}"/>'" value="Update"/>
           <input type="button" class="btn-list delete" onclick="location.href='DeleteVeterinarController?vetId=<c:out value="${v.vetId}"/>',myFunction()" value="Delete"/>
         </td>
        </tr>
      </c:forEach>        
    </tbody>
	...
	<script>
	function myFunction() {
	  alert("Sucessfully delete a veterinar");
	  window.location.href = "ListVeterinarController";
	}
	</script>
